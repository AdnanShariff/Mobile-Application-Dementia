...
/*
Class that is used for Recycler View to display the different types of moods
* */
                ...
                holder.noteButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                       // Toast.makeText(mContext, comment, Toast.LENGTH_LONG).show();
                        ...
                        int iend= comment.indexOf("-");
                        builder.setTitle(comment.substring(0,iend)); //selecting the Exercise Type
                        builder.setMessage(comment.substring(iend+1));  //
                        builder.show();
                    }
                });
            }
